...
<!--        <link href="css/responsive.css" rel="stylesheet">  -->
        ...
        <![endif]-->
        <link href="css/dark-mode.css" rel="stylesheet" id="dark-mode-stylesheet"> 
    </head>
    <body class="<?= isset($_ENV['DARK_MODE']) && (strtolower($_ENV['DARK_MODE']) === 'on' || $_ENV['DARK_MODE'] === 'true') ? 'dark-mode' : '' ?>">
        <!--==========Main Header==========-->
